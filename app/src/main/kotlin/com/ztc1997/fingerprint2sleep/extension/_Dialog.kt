...
class KAlertDialogBuilder(val ctx: Context) {
    ...
    fun neutralButton(textResource: Int = R.string.ok, f: DialogInterface.() -> Unit = { dismiss() }) {
    ...
    fun positiveButton(textResource: Int = R.string.ok, f: DialogInterface.() -> Unit) {
    ...
    fun negativeButton(textResource: Int = R.string.cancel, f: DialogInterface.() -> Unit = { dismiss() }) {
